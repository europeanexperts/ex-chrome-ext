...
function LoginPage(options) {
    ExtensionPage.call(this, options);
}
function ForgotPasswordPage(options) {
    ExtensionPage.call(this, options);
}
function JobsPage(options) {
    ExtensionPage.call(this, options);
}

function JobItemPage(options) {
    ExtensionPage.call(this, options);
}
...
inherit(LoginPage, ExtensionPage, {
    init     : function (options) {
        ...
        this.$el.find('.link').on('click', function (e) { // on Forgot password click
            ...
            APP.setPage(APP.pages.forgotPassword.name);
        });
...
inherit(ForgotPasswordPage, ExtensionPage, {
    init     : function (options) {
        ExtensionPage.prototype.init.call(this, options);
...
inherit(JobsPage, ExtensionPage, {
    init: function (options) {
        ExtensionPage.prototype.init.call(this, options);
        this.items = null;
        ...
        this.$el.find('.createJobBtn').on('click', function (e) {
            ...
            APP.setPage(APP.pages.job.name);
        });
    ...
    onSettingsClick: function (e) {
        ...
        EXT_API.fetchJob(data, function (err, jobData) {
            ...
            APP.setPage(APP.pages.job.name, jobData);
        });
    },
...
inherit(JobItemPage, ExtensionPage, {
    init: function (options) {
        ExtensionPage.prototype.init.call(this, options);
    ...
    onSaveClick: function (e) {
        ...
        EXT_API.saveJob(data, function (err, res) {
            ...
            if (data.id) {
                APP.setPage(APP.pages.jobs.name);
                APP.events.trigger('jobs:update', res);
            } else {
                APP.setPage(APP.pages.jobs.name, {reset: true});
...
(function () {
    window.APP = {
        ...
        unauthorize      : function () {
            ...
            APP.setPage(APP.pages.login.name);
        },
        init             : function () {
